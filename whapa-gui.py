...
class Whapa:
    ...
    def setup_properties(self):
        ...
        self.root.geometry(
            "930x640+"
            + str(int((self.root.winfo_screenwidth() / 2) - (975 / 2)))
            + "+"
            + str(int(self.root.winfo_screenheight() / 2 - (810 / 2)))
        )
    ...
    def setup_variables(self):
        ...
        if system == "Linux":
            ...
            self.whacipher_out_en = StringVar(
                value=os.getcwd() + "/msgstore.db.crypt14"
            )
            self.whacipher_file_en = StringVar(value=os.getcwd() + "/msgstore.db")
            self.whacipher_crypt_en = StringVar(
                value=os.getcwd() + "/msgstore.db.crypt14"
            )
            ...
            self.whacipher_out_en = StringVar(
                value=os.getcwd() + r"\msgstore.db.crypt14"
            )
        ...
        self.instructions_wachat = StringVar(
            value="""To export chats on an Android phone, here are the steps:
...
To export chats on an iOS phone, here are the steps:
   ...
   5. Choose Include or Exclude files.
    ...
    def setup_toolbar(self):
        ...
        self.toolbar_but1 = Button(
            self.toolbar, image=self.iconsearh, command=self.open_folder
        )
        self.toolbar_but1.grid(row=0, column=0)
        ToolTip(self.toolbar_but1, "Open Folder")
        self.toolbar_but2 = Button(
            self.toolbar, image=self.iconreport, command=self.report
        )
        self.toolbar_but2.grid(row=0, column=1)
        ToolTip(self.toolbar_but2, "Open Report")
        self.toolbar_but3 = Button(
            self.toolbar, image=self.iconsetting, command=self.api
        )
        self.toolbar_but3.grid(row=0, column=2)
        ToolTip(self.toolbar_but3, "Configuration")
        self.toolbar_but4 = Button(
            self.toolbar, image=self.iconmanual, command=self.manual
        )
        self.toolbar_but4.grid(row=0, column=3)
        ToolTip(self.toolbar_but4, "Readme")
        self.toolbar_but5 = Button(
            self.toolbar, image=self.iconrequire, command=self.requirements
        )
        self.toolbar_but5.grid(row=0, column=4)
        ToolTip(self.toolbar_but5, "Install requirements")
        self.toolbar_but6 = Button(
            self.toolbar, image=self.iconupdate, command=self.update
        )
        self.toolbar_but6.grid(row=0, column=5)
        ToolTip(self.toolbar_but6, "Update")
        self.toolbar_but7 = Button(
            self.toolbar, image=self.iconabout, command=self.about
        )
    ...
    def setup_tab_panel(self):
        ...
        self.note.add(
            self.tab1, text="WhaPa", image=self.icontabwhapa, compound="left", padding=0
        )
        self.note.add(
            self.tab2,
            text="WhaCipher",
            image=self.icontabcipher,
            compound="left",
            padding=0,
        )
        self.note.add(
    ...
    def setup_tab_whapa(self):
        ...
        self.label_whapa.grid(
            row=0, column=0, sticky="we", padx=5, pady=5, columnspan=2
        )
        ...
        self.entry_whapa_file = Entry(
            self.frame_whapa_db, textvariable=self.whapa_file, width=70
        )
        self.entry_whapa_file.grid(row=0, column=1, sticky="we", padx=5, pady=5)
        self.buttonwhapa_file = Button(
            self.frame_whapa_db,
            image=self.iconfile,
            command=self.search_whapa_file,
            borderwidth=0,
        ...
        self.label_whapa_wa.grid(
            row=1, column=0, sticky="we", padx=5, pady=5, columnspan=1
        )
        self.entry_whapa_wa = Entry(
            self.frame_whapa_db, textvariable=self.whapa_wa, width=70
        )
        self.entry_whapa_wa.grid(
            row=1, column=1, sticky="we", padx=5, pady=5, columnspan=1
        )
        self.button_whapa_wa = Button(
            self.frame_whapa_db,
            image=self.iconfile,
            command=self.search_whapa_wa,
            borderwidth=0,
            highlightthickness=0,
        )
        self.button_whapa_wa.grid(
            row=1, column=2, sticky="w", padx=5, pady=5, columnspan=1
        )
        ...
        self.label_whapa_out.grid(
            row=2, column=0, sticky="we", padx=5, pady=15, columnspan=1
        )
        self.entry_whapa_out = Entry(
            self.frame_whapa_db, textvariable=self.whapa_out, width=70
        )
        self.entry_whapa_out.grid(
            row=2, column=1, sticky="we", padx=5, pady=5, columnspan=1
        )
        self.button_whapa_out = Button(
            self.frame_whapa_db,
            image=self.iconfile,
            command=self.search_whapa_out,
            borderwidth=0,
            highlightthickness=0,
        )
        self.button_whapa_out.grid(
            row=2, column=2, sticky="w", padx=5, pady=5, columnspan=1
        )
        ...
        self.whapa_but_rep_none = Radiobutton(
            self.frame_whapa_repo,
            text="  Terminal",
            image=self.iconone,
            variable=self.whapa_box_rep,
            value="None",
            anchor="w",
            compound="left",
        )
        self.whapa_but_rep_none.config(bd=4, borderwidth=0, highlightthickness=0)
        self.whapa_but_rep_none.grid(
            row=0, column=0, padx=5, pady=(15, 5), sticky="nswe"
        )
        self.whapa_but_rep_es = Radiobutton(
            self.frame_whapa_repo,
            text="  Spanish",
            image=self.icones,
            variable=self.whapa_box_rep,
        ...
        self.whapa_but_rep_en = Radiobutton(
            self.frame_whapa_repo,
            text="  English",
            image=self.iconen,
            variable=self.whapa_box_rep,
        ...
        self.check_whapa_text = Checkbutton(
            self.frame_whapa_filter,
            text="Text",
            borderwidth=0,
            highlightthickness=0,
            variable=self.whapa_text,
        )
        ...
        self.entry_whapa_text.grid(
            row=0, column=1, sticky="we", padx=5, pady=5, columnspan=1
        )
        self.check_whapa_ts = Checkbutton(
            self.frame_whapa_filter,
            text="Start time",
            borderwidth=0,
            highlightthickness=0,
            variable=self.whapa_ts,
        )
        self.check_whapa_ts.grid(row=1, column=0, sticky="w", padx=5, pady=5)
        self.entry_whapa_ts = Entry(self.frame_whapa_filter, width=20)
        self.entry_whapa_ts.grid(
            row=1, column=1, sticky="we", padx=5, pady=5, columnspan=1
        )
        self.check_whapa_te = Checkbutton(
            self.frame_whapa_filter,
            text="End time",
            borderwidth=0,
            highlightthickness=0,
            variable=self.whapa_te,
        )
        self.check_whapa_te.grid(row=2, column=0, sticky="w", padx=5, pady=5)
        self.entry_whapa_te = Entry(self.frame_whapa_filter, width=20)
        self.entry_whapa_te.grid(
            row=2, column=1, sticky="we", padx=5, pady=5, columnspan=1
        )
        self.check_whapa_w = Checkbutton(
            self.frame_whapa_filter,
            text="Whatsapp web",
            borderwidth=0,
            highlightthickness=0,
            variable=self.whapa_w,
        )
        self.check_whapa_w.grid(row=3, column=0, sticky="w", padx=5, pady=5)
        self.check_whapa_s = Checkbutton(
            self.frame_whapa_filter,
            text="Starred",
            borderwidth=0,
            highlightthickness=0,
            variable=self.whapa_s,
        )
        self.check_whapa_s.grid(row=4, column=0, sticky="w", padx=5, pady=5)
        self.check_whapa_b = Checkbutton(
            self.frame_whapa_filter,
            text="Broadcast",
            borderwidth=0,
            highlightthickness=0,
            variable=self.whapa_b,
        )
        self.check_whapa_b.grid(row=5, column=0, sticky="w", padx=5, pady=5)
        self.whapa_but_allme = Radiobutton(
            self.frame_whapa_filter,
            text="All",
            variable=self.whapa_box_filter,
            value="All",
            anchor="w",
            compound="left",
        )
        ...
        self.whapa_but_tr = Radiobutton(
            self.frame_whapa_filter,
            text="Realtime Locations",
            variable=self.whapa_box_filter,
            value="Realtime",
            anchor="w",
            compound="left",
        ...
        self.whapa_but_all = Radiobutton(
            self.frame_whapa_recip,
            text="All",
            variable=self.whapa_box_value,
            value="All",
            anchor="w",
            compound="left",
        )
        ...
        self.whapa_but_group = Radiobutton(
            self.frame_whapa_recip,
            text="Group or Broadcast",
            variable=self.whapa_box_value,
            value="Group",
            anchor="w",
            compound="left",
        ...
        self.whapa_but_user = Radiobutton(
            self.frame_whapa_recip,
            text="Chat",
            variable=self.whapa_box_value,
            value="User",
        ...
        self.whapa_but_user_all = Radiobutton(
            self.frame_whapa_recip,
            text="User",
            variable=self.whapa_box_value,
            value="User_all",
        ...
        ToolTip(
            self.whapa_but_user_all,
            "All messages where the user participates individually or in groups.\nCreating reports with this option may not make sense",
        )
        self.whapa_box_value.set("All")
        self.entry_whapa_user = Entry(
            self.frame_whapa_recip, textvariable=self.whapa_user, width=33
        )
        self.entry_whapa_user.grid(row=4, column=0, sticky="we", padx=5, pady=5)
        self.button_whapa_extract = Button(
            self.frame_whapa_recip,
            image=self.iconinfowhagodri,
            command=self.whapa_info,
            height=32,
            width=64,
        )
        ...
        self.frame_whapa_info.grid(
            row=3, column=0, padx=5, pady=5, sticky="we", columnspan="2"
        )

        self.label_whapa_sep = Label(self.frame_whapa_info, width=25)
        self.label_whapa_sep.grid(row=0, column=0, padx=5, pady=5)
        self.button_whapa_parser = Button(
            self.frame_whapa_info,
            image=self.iconparser,
            command=self.whapa_messages,
            height=32,
            width=64,
        )
        ...
        self.button_whapa_extract = Button(
            self.frame_whapa_info,
            image=self.iconstatus,
            command=self.whapa_status,
            height=32,
            width=64,
        )
        ...
        self.button_whapa_extract = Button(
            self.frame_whapa_info,
            image=self.iconextract,
            command=self.whapa_extract,
            height=32,
            width=64,
        )
        self.button_whapa_extract.grid(row=0, column=4, padx=5, pady=5)
        ToolTip(self.button_whapa_extract, "Extract Thumbnails")
        self.button_whapa_carv = Button(
            self.frame_whapa_info,
            image=self.iconcarving,
            command=self.whapa_carving,
            height=32,
            width=64,
        )
    ...
    def setup_tab_whacipher(self):
        ...
        self.label_whacipher = Label(
            self.tab2,
            text="Whatsapp Encryption and Decryption",
            font=("courier", 15, "bold"),
        )
        self.label_whacipher.grid(
            row=0, column=0, sticky="we", padx=5, pady=5, columnspan=2
        )
        ...
        self.notewhacipher.add(
            self.tabwhacipher1, text="Decrypt", compound="left", padding=0
        )
        self.notewhacipher.add(
            self.tabwhacipher2, text="Encrypt", compound="left", padding=0
        )
        self.notewhacipher.grid(row=1, padx=5, pady=5, sticky="we")

        # Decrypt
        self.whacipher_but_file = Radiobutton(
            self.tabwhacipher1,
            text="File",
            variable=self.whacipher_box_value,
            value="File",
            anchor="w",
            compound="left",
            command=self.estate_assets_whacipher,
        )
        ...
        self.entry_whacipher_file = Entry(
            self.tabwhacipher1, textvariable=self.whacipher_file, width=100
        )
        self.entry_whacipher_file.grid(row=0, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_file = Button(
            self.tabwhacipher1,
            image=self.iconfile,
            command=self.search_file_whacypher,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.whacipher_but_path = Radiobutton(
            self.tabwhacipher1,
            text="Path",
            variable=self.whacipher_box_value,
            value="Path",
        ...
        self.entry_whacipher_path = Entry(
            self.tabwhacipher1, textvariable=self.whacipher_path, width=100
        )
        self.entry_whacipher_path.grid(row=1, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_path = Button(
            self.tabwhacipher1,
            image=self.iconfile,
            command=self.search_path_whacypher,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.entry_whacipher_key = Entry(
            self.tabwhacipher1, textvariable=self.whacipher_key, width=100
        )
        self.entry_whacipher_key.grid(row=2, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_key = Button(
            self.tabwhacipher1,
            image=self.iconfile,
            command=self.search_key_whacypher,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.entry_whacipher_out = Entry(
            self.tabwhacipher1, textvariable=self.whacipher_out, width=100
        )
        self.entry_whacipher_out.grid(row=3, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_out = Button(
            self.tabwhacipher1,
            image=self.iconfile,
            command=self.search_out_whacypher,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.button_whacipher = Button(
            self.tabwhacipher1,
            image=self.icondecrypt,
            command=self.decrypt_whacypher,
            height=32,
            width=64,
        )
        ...
        self.entry_whacipher_file_en = Entry(
            self.tabwhacipher2, textvariable=self.whacipher_file_en, width=100
        )
        self.entry_whacipher_file_en.grid(row=0, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_file_en = Button(
            self.tabwhacipher2,
            image=self.iconfile,
            command=self.search_file_whacypher_en,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.entry_whacipher_path_en = Entry(
            self.tabwhacipher2, textvariable=self.whacipher_crypt_en, width=100
        )
        self.entry_whacipher_path_en.grid(row=1, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_path_en = Button(
            self.tabwhacipher2,
            image=self.iconfile,
            command=self.search_criptofile_whacypher_en,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.entry_whacipher_key_en = Entry(
            self.tabwhacipher2, textvariable=self.whacipher_key_en, width=100
        )
        self.entry_whacipher_key_en.grid(row=2, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_key_en = Button(
            self.tabwhacipher2,
            image=self.iconfile,
            command=self.search_key_whacypher_en,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.entry_whacipher_out_en = Entry(
            self.tabwhacipher2, textvariable=self.whacipher_out_en, width=100
        )
        self.entry_whacipher_out_en.grid(row=3, column=1, sticky="we", padx=5, pady=5)
        self.button_whacipher_out_en = Button(
            self.tabwhacipher2,
            image=self.iconfile,
            command=self.search_out_whacypher_en,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.button_whacipher_en = Button(
            self.tabwhacipher2,
            image=self.iconencrypt,
            command=self.encrypt_whacypher,
            height=32,
            width=64,
        )
    ...
    def setup_tab_whamerge(self):
        ...
        self.entry_whamerge = Entry(
            self.frame_whamerge, textvariable=self.whamerge_path, width=115
        )
        self.entry_whamerge.grid(
            row=1,
            column=0,
            sticky="we",
            padx=5,
        ...
        self.button_whamerge_file = Button(
            self.frame_whamerge,
            image=self.iconfile,
            command=self.search_path_whamerge,
            borderwidth=0,
            highlightthickness=0,
        )
        self.button_whamerge_file.grid(
            row=1,
            column=1,
            sticky="w",
            padx=5,
        ...
        self.entry_whamerge_out = Entry(
            self.frame_whamerge, textvariable=self.whamerge_file, width=115
        )
        self.entry_whamerge_out.grid(
            row=3,
            column=0,
            sticky="we",
            padx=5,
        ...
        self.button_whamerge_fileout = Button(
            self.frame_whamerge,
            image=self.iconfile,
            command=self.search_file_whamerge,
            borderwidth=0,
            highlightthickness=0,
        )
        self.button_whamerge_fileout.grid(
            row=3,
            column=1,
            sticky="w",
            padx=5,
        ...
        self.button_whamerge_run = Button(
            self.frame_whamerge,
            image=self.iconmerge,
            command=self.whamerge,
            height=32,
            width=64,
        )
    ...
    def setup_tab_whagodri(self):
        ...
        self.label_wagodri = Label(
            self.tab4,
            text="Whatsapp Google Drive Extractor",
            font=("courier", 15, "bold"),
        )
        self.label_wagodri.grid(
            row=0, column=0, columnspan=2, sticky="we", padx=5, pady=5
        )
        ...
        self.wagodri_but_info = Radiobutton(
            self.frame_whagodri,
            text="Info about account",
            variable=self.wagodri_box_value,
            value="Info",
            anchor="w",
            compound="left",
        )
        ...
        self.wagodri_but_list = Radiobutton(
            self.frame_whagodri,
            text="List all files",
            variable=self.wagodri_box_value,
            value="List",
        ...
        self.wagodri_but_listw = Radiobutton(
            self.frame_whagodri,
            text="List Whatsapp database file",
            variable=self.wagodri_box_value,
            value="ListW",
            anchor="w",
            compound="left",
        ...
        self.wagodri_sync = Radiobutton(
            self.frame_method_whagodri,
            text="All",
            variable=self.wagodri_box_value,
            value="All",
            anchor="w",
        ...
        self.frame_whagodri_out.grid(
            row=2, column=0, padx=5, pady=10, sticky="nsew", columnspan=2
        )
        self.entry_whagodri_output = Entry(
            self.frame_whagodri_out, textvariable=self.whagodri_path, width=110
        )
        self.entry_whagodri_output.grid(row=0, column=0, sticky="we", padx=5, pady=5)
        self.whagodri_button_path = Button(
            self.frame_whagodri_out,
            image=self.iconfile,
            command=self.search_path_whagodri,
            borderwidth=0,
            highlightthickness=0,
        )
        self.whagodri_button_path.grid(
            row=0,
            column=1,
            sticky="w",
            padx=5,
        ...
        self.button_whagodri_exec = Button(
            self.frame_whagodri_out,
            image=self.icondownwhagodri,
            command=self.wagodri_down,
            height=32,
            width=64,
        )
    ...
    def setup_tab_whachat(self):
        ...
        self.frame_whachat.grid(
            row=1, column=0, padx=5, pady=5, rowspan=2, sticky="nsew"
        )
        ...
        self.entry_whachat_output = Entry(
            self.frame_whachat, textvariable=self.whachat_file, width=70
        )
        self.entry_whachat_output.grid(row=0, column=1, sticky="we", padx=5, pady=5)
        self.whachat_button_path = Button(
            self.frame_whachat,
            image=self.iconfile,
            command=self.search_file_whachat,
            borderwidth=0,
            highlightthickness=0,
        )
        ...
        self.combo_whachat_user = ttk.Combobox(
            self.frame_whachat, width=50, state="readonly"
        )
        ...
        self.entry_whachat_ts.grid(
            row=2, column=1, sticky="w", padx=5, pady=5, columnspan=1
        )
        ...
        self.entry_whachat_te.grid(
            row=3, column=1, sticky="w", padx=5, pady=5, columnspan=1
        )
        ...
        self.whacha_but_rep_none = Radiobutton(
            self.frame_whacha_repo,
            text="  Terminal",
            image=self.iconone,
            variable=self.whachat_box_rep,
            value="None",
            anchor="w",
            compound="left",
        )
        self.whacha_but_rep_none.config(bd=4, borderwidth=0, highlightthickness=0)
        self.whacha_but_rep_none.grid(
            row=0, column=0, padx=5, pady=(15, 5), sticky="nswe"
        )
        self.whacha_but_rep_es = Radiobutton(
            self.frame_whacha_repo,
            text="  Spanish",
            image=self.icones,
            variable=self.whachat_box_rep,
        ...
        self.whacha_but_rep_en = Radiobutton(
            self.frame_whacha_repo,
            text="  English",
            image=self.iconen,
            variable=self.whachat_box_rep,
        ...
        self.whacha_but_rep_es = Radiobutton(
            self.frame_whacha_os,
            text="  Android",
            image=self.iconandroid,
            variable=self.whachat_box_os,
            value="android",
            anchor="w",
            compound="left",
            command=self.estate_assets_whachat,
        )
        self.whacha_but_rep_es.config(bd=4, borderwidth=0, highlightthickness=0)
        ...
        self.combo_whachat_format = ttk.Combobox(
            self.frame_whachat, width=25, state="readonly"
        )
        self.combo_whachat_format["values"] = [
            "%d/%m/%y %H:%M:%S",
            "%d/%m/%Y %H:%M:%S",
            "%d/%m/%y %H:%M",
            "%d/%m/%Y %H:%M",
        ...
        self.button_whachat_exec = Button(
            self.frame_whachat,
            image=self.iconparser,
            command=self.whachat_run,
            height=32,
            width=64,
        )
    ...
    def setup_tab_whacloud(self):
        ...
        self.wacloud_list = Radiobutton(
            self.frame_whacloud,
            text="List all files",
            variable=self.wacloud_box_value,
            value="List",
            anchor="w",
            compound="left",
        )
        ...
        self.frame_whacloud_out.grid(
            row=2, padx=5, pady=10, sticky="nsew", columnspan=2
        )

        self.entry_whacloud_output = Entry(
            self.frame_whacloud_out, textvariable=self.whacloud_path, width=114
        )
        self.entry_whacloud_output.grid(
            row=0, column=0, sticky="we", padx=5, pady=(15, 5)
        )
        self.whacloud_button_path = Button(
            self.frame_whacloud_out,
            image=self.iconfile,
            command=self.search_path_whacloud,
            borderwidth=0,
            highlightthickness=0,
        )
        self.whacloud_button_path.grid(
            row=0,
            column=1,
            sticky="w",
            padx=5,
        ...
        self.button_whacloud_exec = Button(
            self.frame_whacloud_out,
            image=self.icondownwhagodri,
            command=self.wacloud_down,
            height=32,
            width=64,
        )
    ...
    def setup_status_bar(self):
        ...
        self.status_bar_label = Label(
            self.statusbar,
            text=self.label_status,
            textvariable=self.label_status,
            wraplength=975,
        )
    ...
    def setup_shortcuts(self):
        ...
        self.label_box_whagodri_info.bind(
            "<Button-1>",
    ...
    def update(self):
        ...
        if system == "Linux":
            try:
                exec = system_slash(
                    r'python3 "{}/libs/update.py" {}'.format(whapa_path, version)
                )
            except Exception:
                exec = system_slash(
                    r'python "{}/libs/update.py" {}'.format(whapa_path, version)
                )
    ...
    def search_whapa_file(self):
        ...
        self.path = filedialog.askopenfilename(
            title="Select file", filetypes=(("Db files", "*.db"),)
        )
        if system == "Linux":
    ...
    def whapa_messages(self):
        ...
        if system == "Linux":
            exec = system_slash(
                r'python3 "{}/libs/whapa.py" {}'.format(whapa_path, self.cmd)
            )
        else:
            exec = system_slash(
                r'python "{}/libs/whapa.py" {}'.format(whapa_path, self.cmd)
            )
        self.label_status.set(exec)
        os.system(exec)
    ...
    def whapa_carving(self):
        ...
        if system == "Linux":
            ...
            exec_command = system_slash(
                r'"{}/libs/undark" -i "{}" --no-blobs --freespace > "{}"'.format(
                    whapa_path, msgstore_file, log_file
                )
            )
            ...
            c = subprocess.Popen(
                [exec, "-i", msgstore_file, "--no-blobs", "--freespace"],
                stdout=log,
                shell=True,
            )
            c.wait()
            log.close()
            exec_command = system_slash(
                r'{}/libs/undark.exe -i "{}" --no-blobs --freespace > "{}"'.format(
                    whapa_path, msgstore_file, log_file
                )
            )
    ...
    def estate_assets_whacipher(self):
        ...
        if self.whacipher_box_value.get() == "File":
            ...
            try:
                if system == "Linux":
                    self.entry_whacipher_out.insert(
                        0, self.whacipher_out.set(os.getcwd() + "/msgstore.db")
                    )
                else:
                    self.entry_whacipher_out.insert(
                        0, self.whacipher_out.set(os.getcwd() + r"\msgstore.db")
                    )
            except Exception:
                pass
            ...
            try:
                if system == "Linux":
                    self.entry_whacipher_out.insert(
                        0, self.whacipher_out.set(os.getcwd() + "/")
                    )
                else:
                    self.entry_whacipher_out.insert(
                        0, self.whacipher_out.set(os.getcwd() + "\\")
    ...
    def search_file_whacypher(self):
        """Search a path file"""
        self.path = filedialog.askopenfilename(
            title="Select file", filetypes=(("Db crypt files", "*.crypt*"),)
        )
        if system == "Linux":
    ...
    def search_out_whacypher_en(self):
        ...
        if system == "Linux":
            ...
            self.whacipher_out_en.set(
                (self.path + "\\msgstore.db.crypt14").replace("/", "\\")
            )
    ...
    def decrypt_whacypher(self):
        ...
        if system == "Linux":
            exec = system_slash(
                r'python3 "{}/libs/whacipher.py" {}'.format(whapa_path, self.cmd)
            )
        else:
            exec = system_slash(
                r'python "{}/libs/whacipher.py" {}'.format(whapa_path, self.cmd)
            )
        self.label_status.set(exec)
        os.system(exec)
    ...
    def encrypt_whacypher(self):
        ...
        self.cmd += ' -e "{}" "{}"'.format(
            self.whacipher_key_en.get(), self.whacipher_crypt_en.get()
        ).strip("\n")
    ...
    def search_file_whamerge(self):
        ...
        if system == "Linux":
            ...
            self.whamerge_file.set(
                (self.path + "\\msgstore_merge.db").replace("/", "\\")
            )
    ...
    def whamerge(self):
        ...
        if system == "Linux":
            exec = system_slash(
                r'python3 "{}/libs/whamerge.py" "{}" -o "{}"'.format(
                    whapa_path, self.whamerge_path.get(), self.whamerge_file.get()
                )
            )
        else:
            exec = system_slash(
                r'python "{}/libs/whamerge.py" "{}" -o "{}"'.format(
                    whapa_path, self.whamerge_path.get(), self.whamerge_file.get()
                )
            )
    ...
    def search_file_whachat(self):
        ...
        try:
            ...
            if system == "Linux":
                exec = system_slash(
                    r'python3 "{}/libs/whachat.py" "{}" -p -s {}'.format(
                        whapa_path, self.whachat_file.get(), self.whachat_box_os.get()
                    )
                )
            else:
                exec = system_slash(
                    r'python "{}/libs/whachat.py" "{}" -p -s {}'.format(
                        whapa_path, self.whachat_file.get(), self.whachat_box_os.get()
                    )
                )
            ...
            self.label_status.set(
                "Did not get the list of participants choose another operating system and load the file back"
            )
            print(
                "Could not load the list of participants, choose another operating system and load the file back"
            )
    ...
    def whachat_run(self):
        ...
        self.cmd = '"{}" -s {} -f "{}"'.format(
            self.whachat_file.get(),
            self.whachat_box_os.get(),
            self.combo_whachat_format.get(),
        )
        if self.entry_whachat_ts.get() != "dd-mm-yyyy HH:MM":
        ...
        if system == "Linux":
            exec = system_slash(
                r'python3 "{}/libs/whachat.py" {}'.format(whapa_path, self.cmd)
            )
        else:
            exec = system_slash(
                r'python "{}/libs/whachat.py" {}'.format(whapa_path, self.cmd)
            )
    ...
    def wagodri_down(self):
        ...
        if system == "Linux":
            exec = system_slash(
                r'python3 "{}/libs/whagodri.py" {}'.format(whapa_path, self.cmd)
            )
        else:
            exec = system_slash(
                r'python "{}/libs/whagodri.py" {}'.format(whapa_path, self.cmd)
            )
    ...
    def wacloud_down(self):
        ...
        if system == "Linux":
            exec = system_slash(
                r'python3 "{}/libs/whacloud.py" {}'.format(whapa_path, self.cmd)
            )
        else:
            exec = system_slash(
                r'python "{}/libs/whacloud.py" {}'.format(whapa_path, self.cmd)
            )
    ...
    def requirements(self):
        ...
        if system == "Linux":
            exec = system_slash(
                r'sudo pip3 install --upgrade -r "{}/doc/requirements.txt"'.format(
                    whapa_path
                )
            )
        else:
            exec = system_slash(
                r'pip install --upgrade -r "{}/doc/requirements.txt"'.format(whapa_path)
            )
        self.label_status.set(exec)
        os.system(exec)
