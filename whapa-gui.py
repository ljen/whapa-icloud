...
LANG = {
    "ES": {
        ...
        "lang": "English",
        "run": "Ejecutar",
        "hint_start": "Elige una pestana, completa los campos y pulsa el boton de accion.",
        "db": "Base de datos",
        "db_dec": "Base descifrada",
        "contacts": "Contactos (opcional)",
        "outdir": "Carpeta de salida",
        "wafolder": "Carpeta WhatsApp (opcional)",
        "copymedia": "Copiar los adjuntos dentro del informe (entregable en un solo paquete)",
        "mode": "Modo",
        "platform": "Plataforma",
        "auto": "Autodetectar",
        "m_msg": "Mensajes",
        "m_status": "Info: estados",
        "m_calls": "Info: llamadas",
        "m_chats": "Info: chats activos",
        "m_extract": "Extraer adjuntos",
        "m_carving": "Carving",
        ...
        "user": "Usuario",
        "group": "Grupo",
        "byuser": "Mensajes de un numero",
        "broadcast": "Difusion",
        "target": "Numero o grupo",
        "filters": "Filtros",
        "text": "Texto",
        "sender": "Remitente",
        "from": "Desde",
        "to": "Hasta",
        "rawtypes": "Codigos nativos",
        "direction": "Direccion",
        "d_all": "Todas",
        "d_sent": "Enviados",
        "d_recv": "Recibidos",
        ...
        "types": "TIPOS DE MENSAJE (si no marcas ninguno, se incluyen todos)",
        "outsec": "Salida",
        "report": "Informe interactivo",
        "none": "Ninguno",
        "print": "Informe imprimible",
        "csv": "Exportar CSV",
        "kml": "Exportar ubicaciones a KML",
        "maps": "Descargar mapas (necesita internet)",
        "single": "Informe en un solo archivo",
        "cipher_sec": "Descifrado y cifrado de bases de datos",
        "action": "Accion",
        "decrypt": "Descifrar",
        "encrypt": "Cifrar (crypt15)",
        "input": "Archivo de entrada",
        "isdir": "La entrada es un directorio (solo descifrado)",
        "key": "Clave",
        "keyhint": "La clave puede ser el archivo .key, encrypted_backup.key o los 64 caracteres hexadecimales de la clave raiz.",
        "outfile": "Salida",
        "merge_sec": "Fusion de bases de datos",
        "mergefolder": "Carpeta con las bases",
        "mergeout": "Base resultante",
        "gd_sec": "Google Drive",
        "gd_cred": "Las credenciales se leen de cfg/settings.cfg, seccion [google-auth].",
        "gd_info": "Informacion de copias",
        "gd_list": "Listar todo",
        "gd_listwa": "Listar copias de WhatsApp",
        "gd_pull": "Descargar un archivo",
        "gd_sync": "Sincronizar todo",
        "gd_img": "Solo imagenes",
        "gd_vid": "Solo videos",
        "gd_aud": "Solo audios",
        "gd_doc": "Solo documentos",
        "gd_db": "Solo bases",
        "remotefile": "Archivo a descargar",
        "threads": "Hilos",
        "noparallel": "Sin descargas en paralelo",
        "dryrun": "Simulacion (no descarga)",
        "chat_sec": "Chat exportado desde la aplicacion",
        "chatfile": "Archivo del chat",
        "system": "Sistema",
        "chatuser": "Usuario destinatario",
        "datemask": "Mascara de fecha",
        "onlypart": "Solo listar participantes",
        "ic_sec": "iCloud",
        "chatmedia": "Carpeta con los adjuntos exportados",
        "copymedia_short": "Copiar adjuntos al informe",
        "regex": "Regex",
        "ic_cred": "Las credenciales se leen de cfg/settings.cfg, seccion [icloud-auth].",
        "ic_list": "Listar",
        "ic_sync": "Sincronizar todo",
        "ic_img": "Solo imagenes",
        "ic_vid": "Solo videos y audios",
        "cfg_title": "Configuracion",
        "cfg_report": "Datos del informe",
        "cfg_google": "Google Drive",
        "cfg_icloud": "iCloud",
        "cfg_save": "Guardar",
        "cfg_cancel": "Cancelar",
        "cfg_saved": "Configuracion guardada en cfg/settings.cfg",
        ...
        "missing": "Faltan estas dependencias",
        "allok": "Todas las dependencias estan instaladas.",
        ...
        "f_read": "Leidos",
        "f_unread": "Sin confirmar lectura",
        "ph_case": "Diligencias 1234/2026  -  saldra en la portada",
        "ph_examiner": "quien firma el analisis",
        "warn_data": "Faltan datos",
        "warn_db": "Elige una base de datos.",
        "warn_in": "Entrada, clave y salida son obligatorias.",
        "warn_folder": "Elige la carpeta con las bases.",
        "warn_chat": "Elige el archivo del chat.",
    ...
    "EN": {
        ...
        "lang": "Espanol",
        "run": "Run",
        "hint_start": "Pick a tab, fill in the fields and press the action button.",
        "db": "Database",
        "db_dec": "Decrypted database",
        "contacts": "Contacts (optional)",
        "outdir": "Output folder",
        "wafolder": "WhatsApp folder (optional)",
        ...
        "m_calls": "Info: calls",
        "m_chats": "Info: active chats",
        "m_extract": "Extract attachments",
        "m_carving": "Carving",
        ...
        "types": "MESSAGE TYPES (leave all unticked to include every type)",
        "outsec": "Output",
        "report": "Interactive report",
        "none": "None",
        "print": "Printable report",
        "csv": "Export CSV",
        "kml": "Export locations to KML",
        "maps": "Download maps (needs internet)",
        "single": "Single file report",
        "cipher_sec": "Database decryption and encryption",
        "action": "Action",
        "decrypt": "Decrypt",
        "encrypt": "Encrypt (crypt15)",
        "input": "Input file",
        "isdir": "Input is a folder (decryption only)",
        "key": "Key",
        "keyhint": "The key can be the .key file, encrypted_backup.key, or the 64 hex characters of the root key.",
        "outfile": "Output",
        "merge_sec": "Database merge",
        "mergefolder": "Folder with the databases",
        "mergeout": "Resulting database",
        "gd_sec": "Google Drive",
        "gd_cred": "Credentials are read from cfg/settings.cfg, section [google-auth].",
        "gd_info": "Backup information",
        "gd_list": "List everything",
        "gd_listwa": "List WhatsApp backups",
        "gd_pull": "Download a file",
        "gd_sync": "Sync everything",
        "gd_img": "Images only",
        "gd_vid": "Videos only",
        "gd_aud": "Audio only",
        "gd_doc": "Documents only",
        "gd_db": "Databases only",
        "remotefile": "File to download",
        "threads": "Threads",
        "noparallel": "No parallel downloads",
        "dryrun": "Dry run (no download)",
        "chat_sec": "Chat exported from the app",
        "chatfile": "Chat file",
        "system": "System",
        "chatuser": "Target user",
        "datemask": "Date mask",
        "onlypart": "List participants only",
        "ic_sec": "iCloud",
        "chatmedia": "Folder with the exported attachments",
        "copymedia_short": "Copy attachments into report",
        "regex": "Regex",
        "ic_cred": "Credentials are read from cfg/settings.cfg, section [icloud-auth].",
        "ic_list": "List",
        "ic_sync": "Sync everything",
        "ic_img": "Images only",
        "ic_vid": "Videos and audio only",
        "cfg_title": "Settings",
        "cfg_report": "Report details",
        "cfg_google": "Google Drive",
        "cfg_icloud": "iCloud",
        "cfg_save": "Save",
        "cfg_cancel": "Cancel",
        "cfg_saved": "Settings saved to cfg/settings.cfg",
        ...
        "missing": "These requirements are missing",
        "allok": "All requirements are installed.",
        "ph_db": "msgstore.db (Android)  /  ChatStorage.sqlite (iOS)",
        ...
        "f_read": "Read",
        "f_unread": "No read receipt",
        "ph_case": "Case 1234/2026  -  printed on the cover",
        "ph_examiner": "who signs the analysis",
        "warn_data": "Missing data",
        "warn_db": "Choose a database.",
        "warn_in": "Input, key and output are required.",
        "warn_folder": "Choose the folder with the databases.",
        "warn_chat": "Choose the chat file.",
...
class Row:
    ...
    def file(self, label, var, title, types=None, save=False, folder=False, hint=None):
        ...
        ctk.CTkLabel(
            self.m, text=label, text_color=TEXT, anchor="w", font=ctk.CTkFont(**F12)
        ).grid(row=self.r, column=0, sticky="w", padx=(12, 6), pady=4)
        e = ctk.CTkEntry(
            self.m, fg_color=FIELD, border_width=0, placeholder_text=hint or ""
        )
        ...
        def pick():
            if folder:
                ...
                p = filedialog.asksaveasfilename(
                    title=title, filetypes=types or [("Todos", "*.*")]
                )
            else:
    ...
    def checks(self, items, cols=5, label=None):
        ...
        if label:
            ...
            ).grid(row=self.r, column=0, columnspan=4, sticky="w", padx=12, pady=(8, 0))
            self.r += 1
    ...
    def section(self, text):
        ...
        ).grid(row=self.r, column=0, columnspan=4, sticky="w", padx=12, pady=(10, 2))
        self.r += 1
    ...
    def _build(self):
        ...
        for sec, clave, etiqueta in self.CAMPOS:
            if sec != seccion_actual:
                ...
                ctk.CTkLabel(
                    sc,
                    text=T(self.SECCIONES[sec]),
                    text_color=ACCENT,
                    font=ctk.CTkFont(size=13, weight="bold"),
                ).grid(row=fila, column=0, columnspan=2, sticky="w", pady=(14, 4))
                fila += 1
            valor = ""
            ...
            ctk.CTkLabel(
                sc, text=etiqueta, text_color=TEXT, anchor="w", font=ctk.CTkFont(**F12)
            ).grid(row=fila, column=0, sticky="w", padx=(0, 10), pady=3)
        ...
        ctk.CTkLabel(
            barra, text=self.ruta, text_color=MUTED, font=ctk.CTkFont(size=10)
        ).pack(side="left")
...
class WhapaGUI(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title(f"WhaPa {version} - Whatsapp Parser")
    ...
    def _build(self):
        ...
        self.progress = ctk.CTkProgressBar(
            bar, width=160, mode="indeterminate", progress_color=ACCENT
        )
    ...
    def _install_deps(self):
        ...
        if not os.path.exists(req):
            return messagebox.showerror("whapa", f"No se encuentra {req}")
        faltan = []
        try:
            sys.path.insert(0, LIBS)
            import whadeps

            faltan = whadeps.check(
                "Crypto",
                "colorama",
                "customtkinter",
                "requests",
        ...
        if not messagebox.askyesno(self.T("deps_title"), self.T("deps_q") + detalle):
            return
    ...
    def _about(self):
        messagebox.showinfo(
            "WhaPa " + version,
            f"WhaPa {version} - Whatsapp Parser Toolset\n\n"
            "Android e iOS\n"
            "Ivan Moreno (B16f00t)\n"
    ...
    def _tab_whapa(self, tab):
        ...
        r.file(
            self.T("db_dec"),
            self.p_db,
            "msgstore.db / ChatStorage.sqlite",
        ...
        r.checks([(self.p_copymedia, self.T("copymedia"))], cols=1)
        ...
        r.options(
            self.T("scope"),
            self.p_recip,
            ["Todos", "Usuario", "Grupo", "Mensajes de un numero", "Difusion"],
        )
        self.p_target = Field()
        ...
        r.options(
            self.T("direction"),
            self.p_dir,
            ["Todas", "Enviados", "Recibidos", "Del sistema"],
        )
        ...
        r.checks(
            [(self.p_types[k], t) for k, t in tipos], cols=6, label=self.T("types")
        )
        ...
        self.p_out_flags = {
            k: ctk.BooleanVar() for k in ("print", "csv", "kml", "maps", "single")
        }
        r.checks(
            [
                (self.p_out_flags["print"], self.T("print")),
                (self.p_out_flags["csv"], self.T("csv")),
                (self.p_out_flags["kml"], self.T("kml")),
                (self.p_out_flags["maps"], self.T("maps")),
                (self.p_out_flags["single"], self.T("single")),
            ],
            cols=3,
        )
    ...
    def _run_whapa(self):
        ...
        plat = {
            "Android actual": "android",
            "Android antiguo": "android_legacy",
            "iOS": "ios",
        }.get(self.p_platform.get())
        if plat:
            a += ["--platform", plat]
        if self.p_wa.get():
            a += ["-wa", self.p_wa.get()]
    ...
    def _tab_whacipher(self, tab):
        ...
        r.file(
            self.T("input"),
            self.c_in,
            "Base cifrada o descifrada",
            [("Bases", "*.crypt12 *.crypt14 *.crypt15 *.db"), ("Todos", "*.*")],
            hint=self.T("ph_enc"),
        )
        r.checks([(self.c_isdir, self.T("isdir"))], cols=1)
        r.file(self.T("key"), self.c_key, "Archivo de clave", hint=self.T("ph_key"))
        ctk.CTkLabel(
            tab,
            text="La clave puede ser el archivo .key, encrypted_backup.key "
            "o los 64 caracteres hexadecimales de la clave raiz.",
            text_color=MUTED,
            font=ctk.CTkFont(size=11),
            wraplength=820,
            justify="left",
        ).grid(row=r.r, column=0, columnspan=4, sticky="w", padx=12, pady=(0, 4))
        r.r += 1
    ...
    def _run_whacipher(self):
        if not (self.c_in.get() and self.c_key.get() and self.c_out.get()):
            return messagebox.showwarning(
                "Faltan datos", "Entrada, clave y salida son obligatorias."
            )
        a = [tool("whacipher.py")]
    ...
    def _tab_whamerge(self, tab):
        ...
        r.file(
            self.T("mergefolder"),
            self.m_path,
            "Carpeta con msgstore*.db",
            folder=True,
            hint=self.T("ph_mergedir"),
        )
        r.file(
            self.T("mergeout"),
            self.m_out,
    ...
    def _run_whamerge(self):
        if not self.m_path.get():
            return messagebox.showwarning(
                "Faltan datos", "Elige la carpeta con las bases."
            )
    ...
    def _tab_whagodri(self, tab):
        ...
        ctk.CTkLabel(
            sc,
            text="Las credenciales se leen de cfg/settings.cfg, seccion [google-auth].",
            text_color=MUTED,
            font=ctk.CTkFont(size=11),
        ).grid(row=r.r, column=0, columnspan=4, sticky="w", padx=12, pady=(0, 6))
        r.r += 1
        ...
        r.options(
            ...
            self.g_action,
            [
                "Informacion de copias",
                "Listar todo",
                "Listar copias de WhatsApp",
        ...
        r.checks(
            [(self.g_np, self.T("noparallel")), (self.g_dry, self.T("dryrun"))], cols=2
        )
        self.buttons.append(r.run(self.T("run") + " WhaGoDri", self._run_whagodri))

    def _run_whagodri(self):
        mapa = {
            "Informacion de copias": "-i",
            "Listar todo": "-l",
            "Listar copias de WhatsApp": "-lw",
            "Sincronizar todo": "-s",
            "Solo imagenes": "-si",
            "Solo videos": "-sv",
            "Solo audios": "-sa",
        ...
        if acc == "Descargar un archivo":
            if not self.g_file.get():
                return messagebox.showwarning(
                    "Faltan datos", "Indica el archivo a descargar."
                )
            a += ["-p", self.g_file.get()]
        else:
            a.append(mapa[acc])
    ...
    def _tab_whacloud(self, tab):
        ...
        ctk.CTkLabel(
            tab,
            text="Las credenciales se leen de cfg/settings.cfg, seccion [icloud-auth].",
            text_color=MUTED,
            font=ctk.CTkFont(size=11),
        ).grid(row=r.r, column=0, columnspan=4, sticky="w", padx=12, pady=(0, 6))
        r.r += 1
    ...
    def _work_raw(self, argv):
        try:
            ...
            self._emit(
                "[fin] {}".format(
                    "OK" if proc.returncode == 0 else f"codigo {proc.returncode}"
                ),
            ...
            for line in proc.stdout:
                ...
                if line.strip():
                    tag = (
                        ...
                        else ("ok" if line.startswith("[-]") else None)
                    )
                    self._emit(line, tag)
            proc.wait()
