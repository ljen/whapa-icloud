                ...
                try:
                    for msg in elements_message_insert:
                        insert_query = (
                            ...
                            + str_message_cols
                            + ") VALUES ("
                            + ",".join("?" for x in range(len(messages_columns)))
                            + ")"
                        )
                    ...
                    for msg in elements_chatlist_insert:
                        insert_query = (
                            ...
                            + str_chatlist_cols
                            + ") VALUES ("
                            + ",".join("?" for x in range(len(chatlist_columns)))
                            + ")"
                        )
                        cursor_write.execute(insert_query, msg)
                        output.commit()
                    ...
                    for msg in elements_quote_insert:
                        insert_query = (
                            ...
                            + str_quote_cols
                            + ") VALUES ("
                            + ",".join("?" for x in range(len(quote_columns)))
                            + ")"
                        )
                        cursor_write.execute(insert_query, msg)
                        output.commit()
                    ...
                    for msg in elements_thumb_insert:
                        insert_query = (
                            ...
                            + str_thumb_cols
                            + ") VALUES ("
                            + ",".join("?" for x in range(len(thumbnail_columns)))
                            + ")"
                        )
                        cursor_write.execute(insert_query, msg)
                        output.commit()
